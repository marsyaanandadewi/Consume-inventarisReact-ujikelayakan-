...
export default function ModalAdd({ isOpen, closeModal, inputData, judulModal, endpoints }) {
    if (!isOpen) {
        return null;
    }
                                        ...
                                        <div class="mb-6">
                                        {
                                            item.type == "select" ? (
                                                <div>
                                                    ...
                                                    <select name={index} id={index} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500" onChange={handleChange} >
